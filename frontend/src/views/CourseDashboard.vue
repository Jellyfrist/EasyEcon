<template>
    <div class="page-wrapper">
        ...
        <!-- course content from store.currentCourse -->
        <template v-else-if="store.currentCourse">
          ...
          <!-- stats: counts from CourseDetail -->
          ...
          <!-- feature cards: navigate to each content type -->
          <div class="grid-3">
            ...
            <div class="card feature-card pink" @click="router.push(`/courses/${courseId}/flashcards`)">
              <div class="icon-wrapper"><span>🃏</span></div>
              <h2>Flashcards</h2>
              <p>Master key concepts with flashcard sets made by your teacher.</p>
            </div>
    
            <div class="card feature-card yellow" @click="router.push(`/courses/${courseId}/exams`)">
              <div class="icon-wrapper"><span>📝</span></div>
              <h2>Exams</h2>
